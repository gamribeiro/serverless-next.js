...
const prerender_manifest_json_1 = __importDefault(
  require("./prerender-manifest.json")
);
const manifest_json_1 = __importDefault(require("./manifest.json"));
const next_aws_cloudfront_1 = __importDefault(
  require("@sls-next/next-aws-cloudfront")
);
...
const router = (manifest) => {
  ...
  const allDynamicRoutes = Object.assign(
