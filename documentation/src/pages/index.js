...
const features = [
  {
    ...
    description: (
      <>
        There is no configuration needed. You can extend defaults based on your
        application needs.
      </>
    )
  },
  {
    ...
    description: (
      <>
        ...
        application ensuring parity with all of next's features we know and
        love.
      </>
    )
  },
